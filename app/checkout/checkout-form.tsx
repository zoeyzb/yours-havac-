...
export function CheckoutForm() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        apple.on("availablepaymentmethodschange", (e: any) => !dead && setAppleAvailable(Boolean(e?.paymentMethods)))
  ...
  async function initGoogle() {
    ...
    try {
      ...
      el.on("availablepaymentmethodschange", (e: any) => setGoogleAvailable(Boolean(e?.paymentMethods)))
